...
def set_up_mixer():
    pygame.mixer.init()
    background_sound = pygame.mixer.Sound(f"{os.getcwd()}/{MUSIC_PATH}/sakura.wav")
    background_sound.set_volume(0.1)
    # background_sound.play(-1) # loop playing
    bang_sound          = pygame.mixer.Sound(f"{os.getcwd()}/{MUSIC_PATH}/bang.wav")
    bang_sound.set_volume(0.1)
    shot_sound           = pygame.mixer.Sound(f"{os.getcwd()}/{MUSIC_PATH}/eat.wav")
...
def sound_button(screen, SOUND_ON):
    if SOUND_ON:
        button_image = pygame.image.load(f'{os.getcwd()}/{IMAGE_PATH}/sound.png')
    else:
        button_image = pygame.image.load(f'{os.getcwd()}/{IMAGE_PATH}/sound_off.png')
...
def draw_background(surface):
    ...
    moon_image = pygame.image.load(f'{os.getcwd()}/{IMAGE_PATH}/moon.png')
    large_moon_image = pygame.image.load(f'{os.getcwd()}/{IMAGE_PATH}/large_moon.png')
    asteroid_image = pygame.image.load(f'{os.getcwd()}/{IMAGE_PATH}/asteroid.png')
...
def draw_map(surface):
    ...
    button_image = pygame.image.load(f'{os.getcwd()}/{IMAGE_PATH}/bottom.png')
...
def log_life(screen, life_remain):
    my_plane_image =  pygame.image.load(f'{os.getcwd()}/{IMAGE_PATH}/airplane.png')
